...
class ViewImageKtp: UIViewController,mainView{
    ...
    func setupView() {
        ...
        titleImage.topAnchor.constraint(equalTo: self.view!.safeAreaLayoutGuide.topAnchor , constant: 50).isActive = true
        ...
        buttonOk.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -50).isActive = true
